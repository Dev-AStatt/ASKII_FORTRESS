...
public:
	...
	int ItemIDAtPosition(AKI::I3d pos) const;

	std::vector<std::shared_ptr<Object>> fillVectWithObjPtrs(std::vector<AKI::I3d>& vectPos);
	std::shared_ptr<Object> getObjPtrAt(AKI::I3d pos) const;
...
//	olc::vi2d mapBR;
	...
	olc::Pixel colorExchanger(int c) const {
	...
	bool isObjPtrAt(AKI::I3d pos) const;
};
